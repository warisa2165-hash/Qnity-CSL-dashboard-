...
-- CreateTable
CREATE TABLE IF NOT EXISTS "ProgressPoint" (
    "id" TEXT NOT NULL,
    "projectId" TEXT NOT NULL,
    "month" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "PhaseDependency" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "DocumentSubmission" (
    "id" TEXT NOT NULL,
    "projectId" TEXT NOT NULL,
    "code" TEXT NOT NULL,
    "title" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "CapexEquipment" (
    "id" TEXT NOT NULL,
    "projectId" TEXT NOT NULL,
    "code" TEXT NOT NULL,
    "name" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "PaymentChecklistItem" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "SafetyMonthlyStat" (
    "id" TEXT NOT NULL,
    "month" TEXT NOT NULL,
    "sequence" INTEGER NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "OwnerAttentionItem" (
    "id" TEXT NOT NULL,
    "projectId" TEXT NOT NULL,
    "code" TEXT NOT NULL,
    "topic" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AccessRequest_status_requestedAt_idx" ON "AccessRequest"("status", "requestedAt");
...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ProgressPoint_projectId_sequence_key" ON "ProgressPoint"("projectId", "sequence");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ProjectPhase_projectId_sequence_key" ON "ProjectPhase"("projectId", "sequence");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "PhaseDependency_successorId_predecessorId_key" ON "PhaseDependency"("successorId", "predecessorId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "Milestone_status_plannedDate_idx" ON "Milestone"("status", "plannedDate");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Milestone_projectId_code_key" ON "Milestone"("projectId", "code");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "DesignPackage_projectId_discipline_idx" ON "DesignPackage"("projectId", "discipline");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "DocumentSubmission_status_reviewDueDate_idx" ON "DocumentSubmission"("status", "reviewDueDate");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "DocumentSubmission_projectId_code_key" ON "DocumentSubmission"("projectId", "code");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "SubmissionVersion_submissionId_date_idx" ON "SubmissionVersion"("submissionId", "date");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "ProcurementPackage_stage_idx" ON "ProcurementPackage"("stage");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ProcurementPackage_projectId_code_key" ON "ProcurementPackage"("projectId", "code");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "CapexEquipment_riskLevel_idx" ON "CapexEquipment"("riskLevel");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "CapexEquipment_projectId_code_key" ON "CapexEquipment"("projectId", "code");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "PaymentMilestone_projectId_code_key" ON "PaymentMilestone"("projectId", "code");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "Risk_level_status_idx" ON "Risk"("level", "status");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Risk_projectId_code_key" ON "Risk"("projectId", "code");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "SafetyReport_date_idx" ON "SafetyReport"("date");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "SafetyReport_projectId_code_key" ON "SafetyReport"("projectId", "code");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "SafetyMonthlyStat_sequence_key" ON "SafetyMonthlyStat"("sequence");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "ActionItem_status_dueDate_idx" ON "ActionItem"("status", "dueDate");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ActionItem_projectId_code_key" ON "ActionItem"("projectId", "code");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "OwnerAttentionItem_projectId_code_key" ON "OwnerAttentionItem"("projectId", "code");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "Document_projectId_folder_idx" ON "Document"("projectId", "folder");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "DocumentVersion_documentId_uploadedAt_idx" ON "DocumentVersion"("documentId", "uploadedAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "GalleryPhoto_projectId_category_idx" ON "GalleryPhoto"("projectId", "category");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "WeeklyReport_projectId_weekNumber_key" ON "WeeklyReport"("projectId", "weekNumber");
...
-- ---------------------------------------------------------------------
-- migration: 20260803120000_design_discipline_and_safety_summary
-- ---------------------------------------------------------------------

-- CreateTable
CREATE TABLE IF NOT EXISTS "DesignDisciplineStat" (
    "id" TEXT NOT NULL,
    "projectId" TEXT NOT NULL,
    "discipline" TEXT NOT NULL,
    "sequence" INTEGER NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "SafetySummary" (
    "id" TEXT NOT NULL,
    "projectId" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "DesignDisciplineStat_projectId_discipline_key" ON "DesignDisciplineStat"("projectId", "discipline");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "SafetySummary_projectId_key" ON "SafetySummary"("projectId");
